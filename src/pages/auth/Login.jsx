...
function Login() {
  ...
  return (
    <div className="min-h-screen flex">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    disabled={loading}
                    className="appearance-none block w-full pl-12 pr-4 py-3.5 border border-gray-300 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-150 disabled:bg-gray-50 disabled:cursor-not-allowed"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    disabled={loading}
                    className="appearance-none block w-full pl-12 pr-12 py-3.5 border border-gray-300 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-150 disabled:bg-gray-50 disabled:cursor-not-allowed"
      ...
      <div className="hidden lg:block lg:flex-1 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 relative overflow-hidden">
        {/* Decorative Elements */}
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-0 left-1/2 w-72 h-72 bg-indigo-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-4000"></div>
        </div>
            ...
            <div className="space-y-4 text-left">
              <div className="flex items-center gap-4 bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-900">Your data is protected with enterprise-grade security</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-900">Optimized performance for busy medical practices</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-900">Work seamlessly with your entire healthcare team</p>
                </div>
              </div>
            </div>
          </div>
